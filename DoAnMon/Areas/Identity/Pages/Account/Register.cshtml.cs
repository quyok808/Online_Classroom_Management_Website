...
namespace DoAnMon.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = CreateUser();
                await _userStore.SetNormalizedUserNameAsync((CustomUser)user, Input.Name, CancellationToken.None);
                await _userStore.SetUserNameAsync((CustomUser)user, Input.Email, CancellationToken.None);
