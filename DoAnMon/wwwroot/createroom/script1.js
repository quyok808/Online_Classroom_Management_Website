...
const vm = new Vue({
    ...
    methods: {
        ...
        addRoom() {
            // Thực hiện thêm phòng học
            // Điều gì đó ở đây nếu cần
            this.createRoom(); // Gọi hàm tạo meeting sau khi thêm phòng học
        },
        createRoom: async function () {
            ...
            var roomUrl1 = this.roomId;


            $.ajax({
                url: '/ClassRooms/ReceiveRoomUrl',  //Địa chỉ server
                type: 'POST',
                data: { roomUrl1: roomUrl1 },  // dữ liệu tham số gửi (nếu có)
                dataType: "json",
                success: function (data) {
                    console.log("Đã gửi roomUrl thành công.");
                },
                error: function (xhr) {
                    alert(error);
                }
